...
namespace ESunny.Domestic.Quote
{
  ...
  public static class APIInstance
  {
    ...
    [ExcelFunction(Category = "TradingPlatform", Name = "TP.ESunnyDomestic.LoginQuote", Description = "Login to API")]
    public static object Login()
    {
      ...
      {
        AuthCode = Settings.Default.ESunny_Domestic_Quote_AuthCode,
      ...
      var ip = Settings.Default.ESunny_Domestic_Quote_IP;
      var port = Settings.Default.ESunny_Domestic_Quote_Port;
      ...
      {
        UserNo = Settings.Default.ESunny_Domestic_Quote_UserNo,
        Password = Settings.Default.ESunny_Domestic_Quote_Password,
    ...
    [ExcelFunction(Category = "TradingPlatform", Name = "TP.ESunnyDomestic.LogoutQuote", Description = "Log out API")]
    ...
    [ExcelFunction(Category = "TradingPlatform", Name = "TP.ESunnyDomestic.QuoteConnected",
  ...
  public static class APIFunctions
  {
    ...
    [ExcelFunction(Category = "TradingPlatform", Name = "TP.ESunnyDomestic.GetQuoteDetails", Description = "Get quote details")]
    ...
    [ExcelFunction(Category = "TradingPlatform", Name = "TP.ESunnyDomestic.GetQuoteFields", Description = "Get supported quote fields")]
  ...
  {
    public const string ServerProgId = "ApiRtdServer.ESunnyDomesticQuote";
    ...
    public static void ReSubscribeDomesticQuotes()
    {
